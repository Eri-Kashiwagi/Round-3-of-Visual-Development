...
namespace WSC_SimChallenge_2024_Net.PortSimulation
{
    class Simulation
    {
        public double Run(int runIndex, int seed)
        {
            ...
            filePath1 = Path.Combine(filePath1, "AGV_BeingIdleNum_Vessel_DelayedNum1.txt");
            ...
            filePath2 = Path.Combine(filePath2, "AGV_BeingIdleNum_Vessel_DelayedNum2.txt");
            ...
            filePath3 = Path.Combine(filePath3, "AGV_BeingIdleNum_Vessel_DelayedNum3.txt");
            ...
            filePath4 = Path.Combine(filePath4, "AGV_BeingIdleNum_Vessel_DelayedNum4.txt");
            ...
            filePath5 = Path.Combine(filePath5, "AGV_BeingIdleNum_Vessel_DelayedNum5.txt");
            ...
            filePath6 = Path.Combine(filePath6, "AGV_BeingIdleNum_Vessel_DelayedNum6.txt");
            ...
            filePath7 = Path.Combine(filePath7, "AGV_BeingIdleNum_Vessel_DelayedNum7.txt");
            ...
            filePath8 = Path.Combine(filePath8, "AGV_BeingIdleNum_Vessel_DelayedNum8.txt");
            ...
            filePath9 = Path.Combine(filePath9, "AGV_BeingIdleNum_Vessel_DelayedNum9.txt");
            ...
            filePath10 = Path.Combine(filePath10, "AGV_BeingIdleNum_Vessel_DelayedNum10.txt");
