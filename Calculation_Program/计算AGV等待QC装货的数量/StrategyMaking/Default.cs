...
namespace WSC_SimChallenge_2024_Net.StrategyMaking
{
    public class Default
    {
        ...
        public Berth CustomeizedAllocatedBerth(Vessel arrivalVessel)//for vessel arrival and service, we only consider FIFO;
        {
