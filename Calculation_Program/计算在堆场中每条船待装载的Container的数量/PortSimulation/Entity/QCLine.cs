    ...
    public class QCLine
    {
        ...
        public class Loading : BaseActivity<QCLine>
        {
            ...
            public override void TryFinish(Object obj)
            {
                ...
                QCLine workedQCLine = CompletedList.Find(qcLine => qcLine.ServedVessel.Id == container.LoadingVesselID && qcLine.ServedVessel.Week > container.Week);//find the QCLine
                if (workedQCLine != null)
                {
