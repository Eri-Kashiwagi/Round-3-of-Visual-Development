...
namespace WSC_SimChallenge_2024_Net.PortSimulation
{
    public class PortSimModel : Sandbox
    {
        ...
        public static Dictionary<string, Dictionary<int, DateTime>> getweeks = new Dictionary<string, Dictionary<int, DateTime>>();
        Random random;
        ...
        {            
            ...
            for (int orig = 0; orig < numberofVeesel; orig++)
            {
                ...
                for (int week = 0; week < RunningWeeks; week++)
                {
                    ...
                    if (!getweeks.ContainsKey("vessel " + _orig))
                    {
                        getweeks["vessel " + _orig] = new Dictionary<int, DateTime>();
                    }
                    ...
                    getweeks["vessel " + _orig][week] = vesselArrivalTime["vessel " + _orig] + TimeSpan.FromDays(7 * _week) + normalTimeDifference;
                }
            }
        }
