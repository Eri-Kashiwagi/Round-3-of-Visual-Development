    ...
    public class Berth
    {
        ...
        public class BeingIdle : BaseActivity<Berth>
        {
            ...
            public override void AttemptToFinish(Berth berth)
            {
                ...
                {
                    Berth allocatedBerth = StrategyMaker.CustomeizedAllocatedBerth(VesselPendingList[0]);//allocate berth to vessel;
                    allocatedBerth = allocatedBerth == null ? DefaultMaker.CustomeizedAllocatedBerth(VesselPendingList[0]) : allocatedBerth;
