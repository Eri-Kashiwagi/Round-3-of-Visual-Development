...
namespace WSC_SimChallenge_2024_Net.PortSimulation
{
    class Simulation
    {
        public double Run(int runIndex, int seed)
        {
            ...
            filePath1 = Path.Combine(filePath1, "YB_Vessel_Num1.txt");
            ...
            filePath2 = Path.Combine(filePath2, "YB_Vessel_Num2.txt");
            ...
            filePath3 = Path.Combine(filePath3, "YB_Vessel_Num3.txt");
            ...
            filePath4 = Path.Combine(filePath4, "YB_Vessel_Num4.txt");
            ...
            filePath5 = Path.Combine(filePath5, "YB_Vessel_Num5.txt");
            ...
            filePath6 = Path.Combine(filePath6, "YB_Vessel_Num6.txt");
            ...
            filePath7 = Path.Combine(filePath7, "YB_Vessel_Num7.txt");
            ...
            filePath8 = Path.Combine(filePath8, "YB_Vessel_Num8.txt");
            ...
            filePath9 = Path.Combine(filePath9, "YB_Vessel_Num9.txt");
            ...
            filePath10 = Path.Combine(filePath10, "YB_Vessel_Num10.txt");
