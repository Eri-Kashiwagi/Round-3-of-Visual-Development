...
namespace WSC_SimChallenge_2024_Net.PortSimulation
{
    class Simulation
    {
        public double Run(int runIndex, int seed)
        {
            ...
            filePath1 = Path.Combine(filePath1, "AGV_waitlist_container_count_per_yard_Status1.txt");
            ...
            filePath2 = Path.Combine(filePath2, "AGV_waitlist_container_count_per_yard_Status2.txt");
            ...
            filePath3 = Path.Combine(filePath3, "AGV_waitlist_container_count_per_yard_Status3.txt");
            ...
            filePath4 = Path.Combine(filePath4, "AGV_waitlist_container_count_per_yard_Status4.txt");
            ...
            filePath5 = Path.Combine(filePath5, "AGV_waitlist_container_count_per_yard_Status5.txt");
            ...
            filePath6 = Path.Combine(filePath6, "AGV_waitlist_container_count_per_yard_Status6.txt");
            ...
            filePath7 = Path.Combine(filePath7, "AGV_waitlist_container_count_per_yard_Status7.txt");
            ...
            filePath8 = Path.Combine(filePath8, "AGV_waitlist_container_count_per_yard_Status8.txt");
            ...
            filePath9 = Path.Combine(filePath9, "AGV_waitlist_container_count_per_yard_Status9.txt");
            ...
            filePath10 = Path.Combine(filePath10, "AGV_waitlist_container_count_per_yard_Status10.txt");
