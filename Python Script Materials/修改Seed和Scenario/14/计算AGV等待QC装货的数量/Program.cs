...
namespace WSC_SimChallenge_2024_Net.PortSimulation
{
    class Simulation
    {
        public double Run(int runIndex, int seed)
        {
            ...
            filePath1 = Path.Combine(filePath1, "AGV_waitlist_QC1.txt");
            ...
            filePath2 = Path.Combine(filePath2, "AGV_waitlist_QC2.txt");
            ...
            filePath3 = Path.Combine(filePath3, "AGV_waitlist_QC3.txt");
            ...
            filePath4 = Path.Combine(filePath4, "AGV_waitlist_QC4.txt");
            ...
            filePath5 = Path.Combine(filePath5, "AGV_waitlist_QC5.txt");
            ...
            filePath6 = Path.Combine(filePath6, "AGV_waitlist_QC6.txt");
            ...
            filePath7 = Path.Combine(filePath7, "AGV_waitlist_QC7.txt");
            ...
            filePath8 = Path.Combine(filePath8, "AGV_waitlist_QC8.txt");
            ...
            filePath9 = Path.Combine(filePath9, "AGV_waitlist_QC9.txt");
            ...
            filePath10 = Path.Combine(filePath10, "AGV_waitlist_QC10.txt");
