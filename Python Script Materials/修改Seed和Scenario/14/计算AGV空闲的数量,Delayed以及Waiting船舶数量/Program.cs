...
namespace WSC_SimChallenge_2024_Net.PortSimulation
{
    class Simulation
    {
        public double Run(int runIndex, int seed)
        {
            ...
            filePath1 = Path.Combine(filePath1, "AGV_BeingIdleNum_Vessel_DelayedNum_WaitingNum1.txt");
            ...
            filePath2 = Path.Combine(filePath2, "AGV_BeingIdleNum_Vessel_DelayedNum_WaitingNum2.txt");
            ...
            filePath3 = Path.Combine(filePath3, "AGV_BeingIdleNum_Vessel_DelayedNum_WaitingNum3.txt");
            ...
            filePath4 = Path.Combine(filePath4, "AGV_BeingIdleNum_Vessel_DelayedNum_WaitingNum4.txt");
            ...
            filePath5 = Path.Combine(filePath5, "AGV_BeingIdleNum_Vessel_DelayedNum_WaitingNum5.txt");
            ...
            filePath6 = Path.Combine(filePath6, "AGV_BeingIdleNum_Vessel_DelayedNum_WaitingNum6.txt");
            ...
            filePath7 = Path.Combine(filePath7, "AGV_BeingIdleNum_Vessel_DelayedNum_WaitingNum7.txt");
            ...
            filePath8 = Path.Combine(filePath8, "AGV_BeingIdleNum_Vessel_DelayedNum_WaitingNum8.txt");
            ...
            filePath9 = Path.Combine(filePath9, "AGV_BeingIdleNum_Vessel_DelayedNum_WaitingNum9.txt");
            ...
            filePath10 = Path.Combine(filePath10, "AGV_BeingIdleNum_Vessel_DelayedNum_WaitingNum10.txt");
        ...
        static void Main(string[] args)
        {
            ...
            foreach (var seed in Seeds)
            {
                if (!Ifparallel)
                {
                    ...
                    for (int runIndex = 3; runIndex < NumofScenarios; runIndex++)
                    {
